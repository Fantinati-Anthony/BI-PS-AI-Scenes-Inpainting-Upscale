...
class BiAiScenesSdInpaintingProvider implements BiAiScenesApiInterface
{
    use BiAiScenesReplicateProviderTrait;

    // Use a pinned, stable version. Replace with latest SHA when needed.
    public const VERSION = 'stability-ai/stable-diffusion-inpainting';

    public function getName()
    {
        return 'Replicate SD Inpainting';
    }

    public function getKey()
    {
        return 'sd_inpainting';
    }
    ...
    public function generate(array $params)
    {
        ...
        if (isset($params['num_inference_steps'])) {
            $input['num_inference_steps'] = max(1, min(100, (int) $params['num_inference_steps']));
        }
        ...
        return $this->submitPrediction(self::VERSION, $input);
    }
}
